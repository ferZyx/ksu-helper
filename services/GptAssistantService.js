            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Помоги с тестом по веб технологиям, какой единственный верный вариант ответа? Отвечай исключительно одной цифрой - порядковым номером варианта ответа и ничего более."
                        },
                        {
                            type: "image_url",
                            image_url: {
