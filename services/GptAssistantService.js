            ...
            messages: [
                {
                    ...
                    content: [
                        {
                            type: "text",
                            text: "Помоги с тестом по копьютерным сетям, какой единсвенный верный вариант ответа? Отвечай исключительно одной цифрой - порядковым номером варианта ответа и ничего более."
                        },
                        {
                            type: "image_url",
                            image_url: {
